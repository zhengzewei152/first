...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d = new dTree('d');
		d.add(0,-1,'系统菜单树');
		d.add(1,0,'商品管理','/meituan/admin/login/welcome.jsp','','mainFrame');
		d.add(2,0,'订单管理','/meituan/admin/login/welcome.jsp','','mainFrame');
		
		
		//子目录添加
		d.add(11,1,'商品查看','${pageContext.request.contextPath}/servlet/FindAllShopsServlet','','mainFrame');
